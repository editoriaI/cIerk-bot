ENERGY_TAG = "cIerk Core"

SUMMON_WHISPER_TEMPLATE = (
    "[cIerk Core] Summoned. Position synced to x={x:.2f}, y={y:.2f}, z={z:.2f}, facing={facing}."
)

DISCORD_READY_MESSAGE = "cIerk Discord is online and synced with cIerk Core energy."

UNBOXING_QUESTIONS = [
    (
        "primary_mode",
        "What should cIerk prioritize in this guild? (trading, community, support, events)",
    ),
    (
        "moderation_style",
...
HELP_OVERVIEW_LINES = [
    "cIerk is your trade middleman. Use !help [section] or !help [command].",
